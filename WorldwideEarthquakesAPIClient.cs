...
namespace APIVerve
{
    public class WorldwideEarthquakesAPIClient
    {
        ...
        public WorldwideEarthquakesAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WorldwideEarthquakesAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
